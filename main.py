...
import logging
from myGQLib.Classes import outlook_email, Instrument, GQTimer
...
class main(QMainWindow):
    ...
    def generate_dw_signal(self, run_date, tick_size_multiple=1, start_minute=2, read_cache=False):
        ...
        if read_cache:
            ...
            file_path = f"{deploy.prediction_path}\\{deploy.get_next_trading_date(run_date).date()}"
...
if __name__ == '__main__':
    ...
    mMain = main(Appconfig,bot=TG_BOT)
